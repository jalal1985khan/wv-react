      ...
      <Row>
        <Col className="text-center">
          ...
          <Image
              ...
              className='mb-3'
          />
          <p className="col-md-9 mx-auto text-center fs-4 ">Walmart Vriddhi is a supplier development program that has achieved its goal of empowering more than 50,000 MSMEs over five years to expand their domestic capabilities. We are committed to empowering more MSMEs to foster their growth and opportunities.</p>
